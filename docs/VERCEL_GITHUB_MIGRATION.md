...
| `UPLOAD_OWNER_EMAIL` | Vercel Function only | Exact Gmail address allowed to request signed upload URLs. Use the same address embedded in the owner-only Supabase migration. |
